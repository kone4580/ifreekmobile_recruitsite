 ...
 */
$GLOBALS['aiowps_firewall_rules_path'] = __DIR__.'/wp/wp-content/uploads/aios/firewall-rules/';

$GLOBALS['aiowps_firewall_data'] = array(
	'ABSPATH' => '/home/i-freek-recruit/www/recruit.i-freek.co.jp/wp/',
);

// Begin AIOWPSEC Firewall
if (file_exists(__DIR__.'/wp/wp-content/plugins/all-in-one-wp-security-and-firewall/classes/firewall/wp-security-firewall.php')) {
	include_once(__DIR__.'/wp/wp-content/plugins/all-in-one-wp-security-and-firewall/classes/firewall/wp-security-firewall.php');
}
