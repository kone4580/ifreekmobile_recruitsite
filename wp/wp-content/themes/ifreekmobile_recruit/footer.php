...
<?php if (is_page('data')) : ?>
  <script type="text/javascript">
    $(function() {
      ...
      var animationFlag24 = true;
			var animationFlag25 = true;
      ...
      $(window).on('load scroll', function() {
        ...
        if (scroll3 > position3 - windowHeight3 + windowHeight3 / 4) {
          if (animationFlag4) {
            ...
            $('#count6').animateNumber({
              number: 33
            }, 900);
            $('#count7').animateNumber({
              number: 4
            }, 900);
            $('#count8').animateNumber({
              number: 2
            }, 900);
            $('#count9').animateNumber({
              number: 1
            }, 900);
        ...
        if (scroll5 > position5 - windowHeight5 + windowHeight5 / 4) {
          if (animationFlag12) {
            $('#count12').animateNumber({
              number: 90
            }, 1500);
            $('#count13').animateNumber({
              number: 3
            }, 900);
            $('#count14').animateNumber({
              number: 5
            }, 900);
            $('#count15').animateNumber({
              number: 2
            }, 900);
        ...
        if (scroll9 > position9 - windowHeight9 + windowHeight9 / 4) {
          if (animationFlag19) {
            $('#count19').animateNumber({
              number: 16
            }, 900);
            $('#count20').animateNumber({
              number: 38
            }, 900);
            $('#count21').animateNumber({
              number: 42
            }, 900);
            $('#count22').animateNumber({
              number: 4
            }, 900);
        ...
        if (scroll10 > position10 - windowHeight10 + windowHeight10 / 4) {
          if (animationFlag23) {
            $('#count23').animateNumber({
              number: 25
            }, 900);
            $('#count24').animateNumber({
              number: 75
            }, 900);
        ...
        var position11 = $(".box_11").offset().top;
				var scroll11 = $(window).scrollTop();
				var windowHeight11 = $(window).height();
				if (scroll11 > position11 - windowHeight11 + windowHeight11/4){
					if(animationFlag24) {
						var decimal_places = 1;
						var decimal_factor = decimal_places === 0 ? 1 : Math.pow(10, decimal_places);
						$('#count25').animateNumber({
							number: 3.9 * decimal_factor,
						...
						animationFlag24 = false;
					}
				}

				var position12 = $(".box_12").offset().top;
				var scroll12 = $(window).scrollTop();
				var windowHeight12 = $(window).height();
				if (scroll12 > position12 - windowHeight12 + windowHeight12/4){
					if(animationFlag25) {
						$('#count26').animateNumber({ number: 4}, 400);
						$('#count27').animateNumber({ number: 5}, 500);
						animationFlag25 = false;
					}
				}
      });
    });
